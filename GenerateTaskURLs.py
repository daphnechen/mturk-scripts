...
class CrowdsourcingTripleValues:
    ...
    def __init__(self, videos, gold_standards, directory, queries_per_hit=10, workers_per_hit=5, gold_standard_position=7):
        ...
        for video in self.videos:
            ...
            self.result[video] = [0,0,0,0]  # Change this based on the number of possible responses for the task
    ...
    def generate_queries(self):
        ...
        filename = os.path.join(self.directory, "round5-writing-queries" + ".csv")
...
if __name__ == "__main__":
    ...
    videos = []
    with open('source-urls/round5-writing-urls.txt', "r") as video_file:
    ...
    gold_standards = []
    with open('source-urls/gs/gs-writing-urls.txt', "r") as gold_file:
